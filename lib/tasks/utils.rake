    ...
    task seed: :environment do
        ...
        10.times do |i|
            Contact.create!(
                ...
                kind: Kind.all.sample, rmk: LeroleroGenerator.sentence([1,2,3,4,5].sample)
            )
        end
        ...
        Contact.all.each do |contact|
            Address.create!(
                ...
                state: Faker::Address.state_abbr, contact: contact
            )
        end
        ...
        Contact.all.each do |contact|
            Random.rand(1..5).times do |i|
                Phone.create!(
                    phone: Faker::PhoneNumber.phone_number, contact: contact
                )
            end
        end
